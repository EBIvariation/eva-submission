...
-rw-rw-r--    1 ftp      ftp       2206830 Apr 13 13:52 something.txt'''
    ...
    def test_get_vep_versions_from_ensembl(self):
        ...
        self.assertEqual(vep_version, 107)
        self.assertEqual(cache_version, 54)
        ...
        assert os.listdir(os.path.join(cfg['vep_cache_path'], 'thelohanellus_kitauei')) == ['54_ASM82789v1']
