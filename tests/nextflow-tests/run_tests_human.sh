...
cwd=${PWD}
cd ${SCRIPT_DIR}
mkdir project project/accessions project/public ftp
...
nextflow run ${SOURCE_DIR}/accession.nf -params-file test_ingestion_config_human.yaml \
   --accessions_dir ${SCRIPT_DIR}/project/accessions \
	 --public_dir ${SCRIPT_DIR}/project/public
printf "\e[32m==== VARIANT LOAD PIPELINE ====\e[0m\n"
nextflow run ${SOURCE_DIR}/variant_load.nf -params-file test_ingestion_config_human.yaml \
