...
def get_vep_and_vep_cache_version_from_ensembl(db_name, assembly_accession):
    vep_cache_version, ftp_source = get_vep_cache_version_from_ftp(db_name, assembly_accession)
...
def get_vep_cache_version_from_ftp(db_name, assembly_accession):
