...
def insert_assembly(conn, taxonomy_id, assembly_accession, assembly_name, assembly_code, simulate=False):
    if simulate:
        logger.info('Simulate inserting assembly set: INSERT INTO evapro.assembly_set('
                    'taxonomy_id, assembly_name, assembly_code) VALUES ({}, {}, {})'
                    .format(taxonomy_id, assembly_name, assembly_code))
        logger.info('Simulate inserting accessioned assembly: INSERT INTO evapro.accessioned_assembly('
...
def update_accessioning_status(conn, assembly_accession, in_accessioning_flag, simulate=False):
    cur = conn.cursor()
    ...
    cur.execute(assembly_accessioning_store_insert_query) if not simulate \
        else logger.info("Simulating insert into evapro.assembly_accessioning_store_status: " +
...
def insert_taxonomy(conn, taxonomy_id, scientific_name, common_name, taxonomy_code, eva_name, simulate=False):
    ...
    if simulate:
        logger.info('Simulate inserting taxonomy: insert into evapro.taxonomy('
...
def insert_new_assembly_and_taxonomy(
    ...
    :param simulate: Do a simulation run. Tell what the script is going to do, but don't write anything
    :return:
    """
