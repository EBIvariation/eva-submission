...
def main():
    ...
    argparse.add_argument('-f', '--force_delete', action="store_true",
                          help='force delete the existing submission tar file in LTS directory')
    ...
    # Do NOT use context manager to ensure the Submission object does not rewrite the config after deletion!
    submission_deletion = SubmissionDeletion(args.submission_id)
